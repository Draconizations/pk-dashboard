<script lang="ts">
    ...
    import { paginateList } from "$lib/utils/list"
    ...
    $: currentMembers = paginateList($members, activePage, options.pageLength)
</script>
...
<div class="w-full lg:w-1/2 xl:w-1/3">
    ...
    <div class="w-full flex justify-center mt-3">
        <Pagination listLength={$members.length} pageLength={options.pageLength} />
    </div>
</div>
